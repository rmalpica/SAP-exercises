...
Rather than starting from complex Earth System Models, we use **intentionally simplified climate models** to make the *causal structure* explicit:
emissions → concentrations → radiative forcing → temperature response.
...
📓 **Exercise notebook**:  
[Simple climate model →](../exercises/200_simple_climate_model.md)
